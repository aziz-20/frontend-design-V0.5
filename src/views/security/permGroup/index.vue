...
export default {
    ...
    data() {
        ...
        {
            inputtype: "permissionGroupname",
            name:"name",
            label: "Group persmission name",
            placeholder: "Enter Group persmission name",
        },
        {
            inputtype: "menuNameId",
            name: 'menuId',
            label: 'Menu',
        ...
        },
        {
            ...
            name: 'status',
            label: 'Group Permission Status',
        },


    ],
            fields: [
                { "inputtype": "gpermision2", name: "parentId", label: "parent name", placeholder: "Enter the permision name", },
